...
-  Click on the Terminal option in the top menu and select New Terminal.

## Using Bash for this project run this command; This command below will create the project environment
...
![gitbash](./img/usingbashp6.jpg)


![Environment](./img/p6treeenvironment.jpg)

## Enivromnet configuration
...
3. **In the `style.css`** in the `static` directory paste this code below there:
  ...
  ![app.pyconfig](./img/p6apppy.jpg)  

  ![indexhtml](./img/p6indexenv.jpg)

  ![stylecss](./img/p6stylecss.jpg)

### Step 3: Running the Application

## Using this command below on my windows
```bash
python -m venv venv
...
Open a browser and go to `http://127.0.0.1:5000` to see the application.

![application](./img/p6usermanagement1.jpg)

![Adduser](./img/p6usermanagementgmail.jpg)
...
1. **Using Postman**:
   ...
   -  Download Postman if you haven't intsalled it before
    ...
    ![create request](./img/p6createrequestpostman.jpg)
    ...
    - Enter the JSON data:
        ...
        {
            "id": 1,
            "name": "adewusi adegbeminiyi",
            "email": "adewusiadegbeminiyi206@gmail.com"
        }
        ```
...
## NOTE: Edit the name and gmail to your choice.
